        ...
        <article className="grid grid-cols-12">
          <div className="col-start-4 col-end-10 leading-7">
            ...
            <p className="text-lg leading-7 mb-7">
              ...
              sodales ut eu sem integer. Sollicitudin nibh sit amet commodo
              nulla facilisi nullam. Id neque aliquam vestibulum morbi. Tempor
              nec feugiat nisl pretium. Ut pharetra sit amet aliquam id diam
              maecenas ultricies mi. Enim sed faucibus turpis in eu mi bibendum.
            ...
            <p className="text-lg leading-7 mb-7">
              ...
              ornare quam viverra orci sagittis. Neque volutpat ac tincidunt
              vitae semper. Non arcu risus quis varius quam quisque id diam.
              Nulla pellentesque dignissim enim sit amet. Sed velit dignissim
              sodales ut eu. Lobortis scelerisque fermentum dui faucibus in
              ornare quam viverra. Accumsan sit amet nulla facilisi. Sed cras
            ...
            <p className="text-lg leading-7 mb-7">
              ...
              pulvinar mattis nunc sed blandit. A diam maecenas sed enim. Ut
              enim blandit volutpat maecenas volutpat blandit aliquam etiam.
              Platea dictumst vestibulum rhoncus est pellentesque. Venenatis a
            ...
            <p className="text-lg leading-7 mb-7">
              ...
              mauris. A erat nam at lectus urna duis convallis. Feugiat sed
              lectus vestibulum mattis ullamcorper velit. Cum sociis natoque
              penatibus et magnis.
            </p>
            <h4 className="text-3xl mt-7 mb-7 font-semibold">
            ...
            <p className="text-lg leading-7 mb-7">
              ...
              ultrices. Ipsum nunc aliquet bibendum enim facilisis gravida neque
              convallis a. Enim facilisis gravida neque convallis a cras semper.
              Eget arcu dictum varius duis at. Et ligula ullamcorper malesuada
              proin. Orci porta non pulvinar neque laoreet suspendisse interdum
              consectetur. Volutpat est velit egestas dui id ornare arcu odio.
              Sed sed risus pretium quam.
            </p>
            <p className="text-lg leading-7 mb-7">
              Donec ac odio tempor orci dapibus ultrices. Integer quis auctor
              elit sed vulputate mi sit amet. Sollicitudin ac orci phasellus
              egestas tellus. Potenti nullam ac tortor vitae purus. Risus
              feugiat in ante metus dictum at tempor. Nibh cras pulvinar mattis
              nunc. Nulla at volutpat diam ut. Vivamus arcu felis bibendum ut
              tristique et egestas quis ipsum. Volutpat sed cras ornare arcu dui
              vivamus. Massa eget egestas purus viverra. Pellentesque elit eget
              gravida cum sociis natoque. Tortor dignissim convallis aenean et
