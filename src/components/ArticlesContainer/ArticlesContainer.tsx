...
export const ArticlesContainer = () => {
  return (
    <div className="grid grid-rows-[auto_1fr] grid-cols-1 px-2 sm:px-16 pt-8  pb-8 sm:pt-32 sm:pb-16 gap-6 sm:gap-16 text-[#031206] bg-[#e3ede6]">
      <h3 className="text-4xl sm:text-6xl font-IBMSerifMedium opacity-90">
        NEWS ABOUT US
      </h3>
      <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-auto md:grid-rows-1 grid-start-2 grid-end-3 gap-8">
        <div className="grid grid-rows-auto md:grid-rows-[min-content_150px_180px_auto] lg:grid-rows-[min-content_1fr_180px_auto] gap-4">
          <img
          ...
          <h6 className="text-sm sm:text-base opacity-[85%] sm:opacity-70 line-clamp-none md:line-clamp-[7]">
        ...
        <div className="grid grid-rows-auto md:grid-rows-[min-content_150px_180px_auto] lg:grid-rows-[min-content_1fr_180px_auto gap-4">
          ...
          <h6 className="text-sm sm:text-base opacity-[85%] sm:opacity-70 line-clamp-none sm:line-clamp-3 md:line-clamp-[7]">
