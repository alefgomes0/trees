...
export const ArticlesContainer = () => {
  return (
    <div className="grid grid-rows-[auto_1fr] grid-cols-1 px-2 sm:px-16 pt-8  pb-8 sm:pt-32 sm:pb-16 gap-6 sm:gap-16 text-[#031206] bg-[#e3ede6]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 grid-rows-auto sm:grid-rows-1 grid-start-2 grid-end-3 gap-8">
        <div className="grid grid-rows-auto md:grid-rows-[min-content_150px_180px_auto] gap-4">
          <img
            ...
            className="sm:h-[300px] object-cover rounded shadow-[0_3px_3px_0_rgba(0,0,0,0.2)]"
          />
          <h4 className="text-xl sm:text-2xl font-IBMSerifMedium">
            Hac habitasse platea dictumst sagittis purus.
          </h4>
          <h6 className="text-sm sm:text-base opacity-[85%] sm:opacity-70 line-clamp-none md:line-clamp-3 lg:line-clamp-none">
        ...
        <div className="grid grid-rows-auto sm:grid-rows-[1fr_150px_180px_auto] gap-4">
          <img
        ...
        <div className="grid grid-rows-auto sm:grid-rows-[min-content_150px_180px_auto] gap-4">
          <img
            src="../../../images/fabian-jones-r_hgv8qEkwU-unsplash.jpg"
            className="object-cover sm:h-[300px] rounded shadow-[0_3px_3px_0_rgba(0,0,0,0.2)"
          />
