...
export const UnderHeaderCTA = () => {
  return (
    <div className="absolute left-50 flex flex-col gap-4 w-max self-end justify-self-center h-max items-center text-white py-2 px-4 bg-gradient-to-b from-[rgba(0,0,0,0.15)] to-[rgba(0,0,0,0.25)]">
      <h3 className="text-4xl font-IBMSerifMedium">SOME THINGS CANNOT WAIT</h3>
      <h4 className="w-[60%] opacity-90 text-xs">
