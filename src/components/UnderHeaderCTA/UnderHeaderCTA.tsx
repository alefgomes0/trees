export const UnderHeaderCTA = () => {
  return (
    <div className="flex flex-col gap-4 w-max self-end justify-self-center h-max items-center text-[#e3ede6] py-2 px-4 bg-gradient-to-b from-[rgba(0,0,0,0.15)] to-[rgba(0,0,0,0.4)]">
      <h3 className="text-4xl font-semibold">SOME THINGS CANNOT WAIT</h3>
