      ...
      <div className="grid col-start-1 cold-end-2 mt-16 gap-4">
        ...
        <div>
          <h4 className="text-2xl font-IBMSansLight leading-9">
            ...
            biodiversity and people. <span className="font-IBMSansSemibold opacity-[75%]">
              Wildfires are projected to rise by 50 per
              cent by the end of the century
            </span> due to the climate crisis and changes
            in land use
          </h4>
        </div>
      </div>
      <div className="grid col-start-2 col-end-3 gap-6 mt-[75px]">
        <div className="flex gap-4">
          <img
            ...
            className="w-[150px] h-[150px] rounded bg-[#8cc09b] p-3"
            key={0}
          />
