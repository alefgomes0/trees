...
export const Newsletter = () => {
  ...
  return (
    <>
      <div className="relative h-[50svh] bg-[url('../../../images/azzedine-rouichi-ijdx54zvv28-unsplash.jpg')] bg-cover bg-center shadow-[0_3px_3px_0_rgba(0,0,0,0.3)]">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="w-40 sm:w-64 h-4 sm:h-6 rounded text-xs border-none outline-none focus:outline-[3px] focus:outline-offset-0 focus:outline-sky-400 placeholder:text-black placeholder:text-xs pl-1"
                  required={true}
                  min={5}
                  max={40}
                  ref={nameInputRef}
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="focus:invalid:outline-red-500 w-40 sm:w-64 h-4 sm:h-6 rounded text-xs border-none outline-none focus:outline-[3px] focus:outline-offset-0 focus:outline-sky-400 placeholder:text-black placeholder:text-xs pl-1"
                  required={true}
                  min={5}
                  max={40}
                  ref={emailInputRef}
      ...
      <div className="bg-[#e3ede6] h-16"></div>
    </>
  );
};
