...
export const TopNews = () => {
  return (
    <div className="w-max lg:w-[99%] h-max lg;h-96 grid grid-cols-1 grid-rows-[auto_1fr_1fr_1fr_1fr] col-start-1 col-end-2 lg:col-start-10 lg:col-end-12 mt-6 lg:mt-40">
